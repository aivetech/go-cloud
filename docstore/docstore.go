...
import (
	...
	"github.com/aivetech/gocloud.dev/internal/oc"
)
...
const pkgName = "github.com/aivetech/gocloud.dev/docstore"
...
// AlreadyExists is returned if it does. (See github.com/aivetech/gocloud.dev/gcerrors for more on error
// codes.)
//
...
// (See github.com/aivetech/gocloud.dev/gcerrors for more on error codes.)
//
...
// https://godoc.org/github.com/aivetech/gocloud.dev/docstore#hdr-Revisions.
...
// driver-specific types. See https://github.com/aivetech/gocloud.dev/concepts/as for background
// information.
...
// https://github.com/aivetech/gocloud.dev/concepts/as/ for background information and the
