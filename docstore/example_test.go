...
import (
	...
	_ "github.com/aivetech/gocloud.dev/docstore/awsdynamodb"
	_ "github.com/aivetech/gocloud.dev/docstore/gcpfirestore"
...
func ExampleOpenCollection() {
	...
	//   import _ "github.com/aivetech/gocloud.dev/docstore/gcpfirestore"
...
func ExampleCollection_As() {
	...
	// https://godoc.org/github.com/aivetech/gocloud.dev/docstore/gcpfirestore#hdr-As
...
func ExampleCollection_ErrorAs() {
	...
	// You will need to blank-import the package for this to work:
	//   import _ "github.com/aivetech/gocloud.dev/docstore/awsdynamodb"

	// The types exposed for As by mongodocstore are documented in
	// https://godoc.org/github.com/aivetech/gocloud.dev/docstore/mongodocstore#hdr-As
