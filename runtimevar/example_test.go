...
func Example_jsonDecoder() {
	...
	const jsonConfig = `{"Host": "github.com/aivetech/gocloud.dev", "Port": 8080}`
	...
	// PRAGMA: On github.com/aivetech/gocloud.dev, hide the rest of the function.
	...
	// Output:
	// Config: {Host:github.com/aivetech/gocloud.dev Port:8080}
}
...
func ExampleSnapshot_As() {
	...
	// https://godoc.org/github.com/aivetech/gocloud.dev/runtimevar/gcpruntimeconfig#hdr-As
	ctx := context.Background()
