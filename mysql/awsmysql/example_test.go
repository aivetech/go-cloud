...
import (
	...
	_ "github.com/aivetech/gocloud.dev/mysql/awsmysql"
)

func Example() {
	// PRAGMA: This example is used on github.com/aivetech/gocloud.dev; PRAGMA comments adjust how it is shown and can be ignored.
	// PRAGMA: On github.com/aivetech/gocloud.dev, add a blank import: _ "github.com/aivetech/gocloud.dev/mysql/awsmysql"
