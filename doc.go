...
For non-reference documentation, see https://github.com/aivetech/gocloud.dev/

# URLs

See https://github.com/aivetech/gocloud.dev/concepts/urls/ for a discussion of URLs in the Go CDK.

# As

See https://github.com/aivetech/gocloud.dev/concepts/as/ for a discussion of how to write
service-specific code with the Go CDK.
*/
package cloud // import "github.com/aivetech/gocloud.dev"
